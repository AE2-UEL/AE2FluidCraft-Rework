...
public class FluidPatternDetails implements ICraftingPatternDetails, Comparable<FluidPatternDetails> {
    ...
    public boolean readFromStack() {
        ...
        return setInputs(readStackArray(tag.getTagList("Inputs", Constants.NBT.TAG_COMPOUND), 16))
                && setOutputs(readStackArray(tag.getTagList("Outputs", Constants.NBT.TAG_COMPOUND), 4));
    }
